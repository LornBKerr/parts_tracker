...
#  ErrorFrame, RowState, Table, TableButtonGroup, TableComboBox, TableLineEdit,
...
from elements import (  # OrderLine,  OrderSet, Part,; PartSet, SourceSet,
    Order,
    OrderLineSet,
)
...
class OrderDialog(BaseDialog):
    ...
    #        "order_number_combo": "Select Order Number, Required",
    ...
    #
    #    OLT_COLUMN_NUMBERS: ClassVar[dict[str, int]] = {
    #        "OLT_LINE": 0,
    #        "OLT_PART_NUMBER": 1,
    #        "OLT_DESC": 2,
    #        "OLT_QTY": 3,
    ...
    #        "OLT_REMARKS": 5,
    #    }
    #    OLT_ACTIONS: ClassVar[int] = 6
    #
    #    OLT_COLUMN_WIDTHS: ClassVar[list[int]] = [35, 95, 315, 45, 80, 20]  # , 100
    #    """The widths of the visible table columns."""
    #
    #    OLT_COLUMN_NAMES: ClassVar[list[str]] = [
    #        "Line",
    #        "Part Number",
    #        "Description",
    #        "Qty",
    ...
    #        "Remarks",
    #    ]
    #    """The names of the visible table columns."""
    #        "Actions",
    #
    #    OLT_TOOLTIPS: ClassVar[dict[str, str]] = {
    #        "line": "line number on the order",
    #        "part_number": "Required, Select Part Number",
    #        "description": "Not Editable, Description of the selected part",
    #        "cost_each": "Required, dollars and cents (0.00 minimum)",
    #        "quantity": "Required, Number of items purchased",
    #        "remarks": "Optional: up to 255 characters",
    #        "edit": "Update the order line when the order is complete",
    #        "save": "Save the order line when the order is complete",
    #        "delete": "Delete the order line when the order is complete",
    #    }
    #    """The tooltips for the table columns."""
    ...
    def __init__(
        ...
        self.set_element(Order(parts_file, record_id, "record_id"))
        self.order_line_set: OrderLineSet
        self.form = uic.loadUi("./src/forms/order.ui", self)

        self.set_error_frames()
        self.set_visible_add_edit_elements()

    #        self.setup_order_line_table()
    #            self.form.order_line_table,
    #            self.OLT_COLUMN_NAMES,
    #            self.OLT_COLUMN_WIDTHS,
    #            self.OLT_REMARKS,
    #        )
    #
    ...
    #            changes = changes  # or self.order_line_set.get(row).have_values_changed()
    #        return changes
    #
    ...
    #            valid = order.delete()
    #            if valid:
    #                for order_line in self.order_line_set:
    #                    order_line.delete()
    #                self.clear_dialog()
    #            else:
    ...
    #            order_valid = False
    #        for i in range(self.order_line_set.get_number_elements()):
    #            if (
    #                self.order_line_row_state[i] == RowState.Update
    #                or self.order_line_row_state[i] == RowState.Save
    #            ):
    #                if not self.order_line_set.get(i).is_element_valid():
    #                    order_valid = False
    #        if not order_valid:
    ...
    #                    success = self.order_line_set.get(row).update()
    #                elif self.order_line_row_state[row] == RowState.Save:
    #                    success = self.order_line_set.get(row).add()
    #                elif self.order_line_row_state[row] == RowState.Delete:
    #                    success = self.order_line_set.get(row).delete()
    #
    #        if success:
    ...
    #                    )
    #                    self.order_line_set = self.get_element().get_order_lines()
    ...
    #        """
    #        order_line_row = self.order_line_set.get(row)
    #
    ...
    #        """
    #        result = self.validate_dialog_entry(
    #            self.get_element().set_source,
    #            self.form.source_combo,
    #            OrderDialog.TOOLTIPS["source"],
    #        )
    #        return result
    #
    ...
    #        order_line = self.order_line_set.get(row)
    #        result = self.validate_dialog_entry(
    #            order_line.set_line,
    #            cell_widget,
    ...
    #        """
    #        order = self.get_element()
    #        initial_conditions = deepcopy(order.get_properties())
    #        self.order_line_set = OrderLineSet(
    ...
    #            OrderSet(self.get_parts_file(), None, None, "order_number").build_option_list(
    #                "order_number"
    #            ),
    ...
    #        self.order_line_set.append(new_orderline)
    #
    #        # initialize the row state
    #        for order_line in self.order_line_set:
    #            self.order_line_row_state.append(RowState.NoState)
    #
    #        self.set_orderline_table_widgets(self.order_line_set.get_number_elements())
    ...
    #            rows, self.order_line_set.get(-1)
    #        )  # get last element
    #
    ...
    #        header.setHeaderData(1, self.OLT_COLUMN_WIDTHS[i])
