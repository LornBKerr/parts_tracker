"""
Edit the set of OrderLines for an order

File:       order_line_model.py
Author:     Lorn B Kerr
...
class OrderLineModel(TableModel):
    """Display/Edit the set of order_lines for an Order."""
...
#            "QTableView {selection-background-color: self.NORMAL_BACKGROUND; selection-color: blue;}"
#        )
#
#        self.setup_form()
#        self.append_row()
