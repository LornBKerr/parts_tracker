"""
This is a set of Orders in the database.
...
class OrderSet(ElementSet):
    ...
    def __init__(
        ...
        """
        Build a set of Orders from the database table 'orders'.

        Parameters:
            dbref (Dbal): reference to the database holding the Orders.
        ...
        offset (intr): row number to start retrieval, 0 based, defaults
            to row 0.
        """
        table_name = "orders"  # The database table for this element
        element_type = Order
